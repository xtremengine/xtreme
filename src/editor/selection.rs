//! # Selection System
//!
//! Handles object selection and ray picking in the editor viewport.

use glam::{Mat4, Vec3};

// Re-export SceneObject and ObjectId from scene_object module
pub use crate::editor::scene_object::{ObjectId, SceneObject};
